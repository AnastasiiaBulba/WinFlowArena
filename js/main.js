...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  await loadPartial("header", "./duck_partials/header.html");
  await loadPartial("footer", "./duck_partials/footer.html");
  if (window.location.pathname.includes("duck-contacts.html")) {
    await loadPartial("contact-info", "./duck_partials/contact-info.html");
  }
  ...
  console.log("Duck Duck Adventure website initialized successfully!");
});
